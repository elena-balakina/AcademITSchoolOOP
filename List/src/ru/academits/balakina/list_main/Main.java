...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Список: " + singlyLinkedList);
        ...
        System.out.println("Список после удаления элемента по индексу 0: " + singlyLinkedList);
        System.out.println("Размер списка = " + singlyLinkedList.getCount());
        System.out.println();
        ...
        System.out.println("Список после вставки нового элемента: " + singlyLinkedList);
        ...
        System.out.println("Список после удаления первого элемента: " + singlyLinkedList);
        System.out.println("Размер списка = " + singlyLinkedList.getCount());
        System.out.println();
        ...
        System.out.println("Список после разворота: " + singlyLinkedList);
        System.out.println();

        // копирование списка
        SinglyLinkedList<String> singlyLinkedListCopy = singlyLinkedList.copy();
        System.out.println("Копия списка: " + singlyLinkedListCopy);
    }
}
